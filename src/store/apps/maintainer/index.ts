...
export const fetchData = createAsyncThunk('appMaintainer/fetchData', async (qr: string, { dispatch }) => {
...
export const appMaintainerSlice = createSlice({
  name: 'appMaintainer',
  initialState,
  reducers: {
    showQrModal: state => {
...
export const { showQrModal, hideQrModal, wrongVehiclePlate, rightVehiclePlate, reset } = appMaintainerSlice.actions

export default appMaintainerSlice.reducer
